...
const ACTION_BADGE_CLASS: Record<string, string> = {
  ...
  'user.ban': 'bg-dangerSoft',
  'user.unban': 'bg-successSoft',
  'user.suspend': 'bg-warningSoft',
  'user.unsuspend': 'bg-successSoft',
  'project.delete': 'bg-dangerSoft',
  'project.hide': 'bg-warningSoft',
  'project.unhide': 'bg-successSoft',
  'project.feature': 'bg-primary',
  'project.unfeature': 'bg-gray-200',
  'comment.delete': 'bg-dangerSoft',
  'comment.hide': 'bg-warningSoft',
  'comment.unhide': 'bg-successSoft',
