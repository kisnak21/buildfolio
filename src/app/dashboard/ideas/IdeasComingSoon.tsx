      ...
      <div className='flex flex-1 items-center justify-center py-8'>
        <div className='w-full max-w-2xl rounded-2xl border-4 border-dark bg-white p-8 text-center shadow-brutal-lg sm:p-12'>
          ...
          <p className='mx-auto mt-4 max-w-xl text-lg font-semibold leading-relaxed text-gray-600'>
            We are evaluating AI capacity and reliability before reopening idea
            and document generation.
          </p>
          <p className='mx-auto mt-3 max-w-xl text-sm font-semibold text-gray-500'>
            Routing stays at{' '}
            <span className='font-black text-dark'>/dashboard/ideas</span>. No
            generations are consumed while this workspace is paused.
          </p>
          <div className='mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row'>
            ...
            <Link
              href='/dashboard/new'
              className='inline-flex min-h-11 items-center justify-center rounded-xl border-2 border-dark bg-white px-6 py-3 font-black shadow-brutal-sm hover:bg-inputBg'
            >
