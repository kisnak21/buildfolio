...
const IdeasClient = () => {
  ...
  const handleGenerate = async (event: React.FormEvent) => {
    ...
    try {
      const result = await generateAiContent('ideas', model, {
      ...
      setError(
        apiError.response?.data?.message ||
          'Could not generate ideas. Please try another model.',
      )
        ...
        <div className='grid gap-8 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] lg:items-start'>
          ...
          >
            ...
            <div className='mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2'>
              ...
              <div>
                <label htmlFor='idea-model' className='mb-2 block font-black'>
                  Model
                </label>
                <select
                  id='idea-model'
